...
puts "Juha finishes, 'based on your work so far, they want to offer you a position as a Jr. Rails Developer" 
puts "as soon as you finish Wyncode!'"
%x( say 'Yoo ha finishes, based on your work so far, they want to offer you a position as a Junior Rails Developer as soon as you finish Wyncode')
puts
